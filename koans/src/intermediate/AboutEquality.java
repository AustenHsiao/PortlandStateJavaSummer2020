...
public class AboutEquality {
    ...
    static class Car {
        ...
        public boolean equals(Object other) {
            ...
            if(other instanceof Car){
                // same stuff
                if(((Car) other).horsepower == this.horsepower && ((Car) other).name == this.name){
                    return true;
                }
            }
            return false;
    ...
    public void ownHashCodeImplementationPartTwo() {
        ...
        // Does this still fit the hashCode contract? Why (not)?
            // in its original form, we're binning everything into the same category-- 4000. This makes the hashCode useless.
