...
public class AboutPrimitives {
    ...
    public void longsHaveALargerRangeThanInts() {
        assertEquals(Long.MIN_VALUE, parseLong("-9223372036854775808"));
        assertEquals(Long.MAX_VALUE, parseLong("9223372036854775807"));
    }
    ...
    public void charsCanOnlyBePositive() {
        assertEquals((int) Character.MIN_VALUE, (int)'\u0000');
